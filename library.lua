...
local Library = {
    ...
    MainColor = Color3.fromRGB(0, 0, 48);
    BackgroundColor = Color3.fromRGB(7, 0, 43);
    AccentColor = Color3.fromRGB(0, 71, 255);
    OutlineColor = Color3.fromRGB(0, 5, 79);
...
function Library:MakeDraggable(Instance, Cutoff)
    ...
    local framePos = Instance.Position
    local dragInput
...
function Funcs:AddKeyPicker(Idx, Info)
    ...
    Library:GiveSignal(InputService.InputBegan:Connect(function(Input)
        ...
        if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
            ...
            if Mouse.X < AbsPos.X or Mouse.X > AbsPos.X + AbsSize.X
                or Mouse.Y < (AbsPos.Y - 21) or Mouse.Y > AbsPos.Y + AbsSize.Y then
                ModeSelectOuter.Visible = false
            end
        end
    end))
